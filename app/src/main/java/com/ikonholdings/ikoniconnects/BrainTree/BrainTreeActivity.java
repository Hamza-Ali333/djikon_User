package com.ikonholdings.ikoniconnects.BrainTree;
...
public class BrainTreeActivity extends AppCompatActivity {
    ...
    private void postNonceToServer(String nonce) {
        ...
        params.put("sender_id", 4);
        params.put("service_id", 12);
        client.post("http://ec2-52-91-44-156.compute-1.amazonaws.com/api/chekout", params,
                new AsyncHttpResponseHandler() {
                    ...
                    public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                        ...
                        Toast.makeText(BrainTreeActivity.this, "Cancel From "+statusCode, Toast.LENGTH_SHORT).show();
                    }
                }
        );
        Log.i("TAG", "postNonceToServer: nonce  "+nonce);
//        jsonApiHolder = retrofit.create(JSONApiHolder.class);
//        Call<SuccessErrorModel> call = jsonApiHolder.postNonceToServer(
...
//                    Toast.makeText(BrainTreeActivity.this, "Done", Toast.LENGTH_SHORT).show();
//                }else {
//                    Toast.makeText(BrainTreeActivity.this, "Failed", Toast.LENGTH_SHORT).show();
//                }
//            }
//
//            @Override
//            public void onFailure(Call<SuccessErrorModel> call, Throwable t) {
//                Toast.makeText(BrainTreeActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
