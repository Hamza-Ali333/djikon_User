...
import com.example.djikon.GlobelClasses.MyApp;
...
public class CheckoutActivity extends AppCompatActivity {
        ...
        payButton.setOnClickListener((View view) -> {
            ...
            if (params != null) {
                ...
                try {
                    ...
                    Log.i("Checkout", "startCheckout: "+e.getMessage());
                }
            }
        });
    }
    ...
    private void onPaymentSuccess(@NonNull final Response response) throws IOException {
        ...
        String stripePublishableKey = responseMap.get("pk_test_51HCIELE5A9WQBmcX4wLziqdx2Sh9mLSg9RazyKvMn7asXrADnOK5WNjhwj7NV2NmCd8OrgFMwaCkTF7k4TmAtXVm00SCKvMjqJ");
        paymentIntentClientSecret = responseMap.get("sk_test_51HCIELE5A9WQBmcXoiygS2piXUQSCWj7JkjPslklXAJIxDqQfyhIJObKmAYmIKsstvEUgb6NNl4blVPRy9vctQKF00eI1VKtfP");
    ...
    private static final class PayCallback implements Callback {
        ...
        public void onFailure(@NonNull Call call, @NonNull IOException e) {
            ...
            Log.i("CheckOut", "onFailure: Error "+ e.toString());
        }
